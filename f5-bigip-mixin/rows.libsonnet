  ...
  new(this)::
    {
      ...
      poolOverviewRow:
        ...
        + g.panel.row.withPanels([
          panels.poolAvailabilityStatusTable { gridPos: { w: 12 } },
          panels.poolRequestsTimeSeries { gridPos: { w: 12 } },
          panels.poolMembersTimeSeries { gridPos: { w: 24 } },
          panels.poolConnectionsTimeSeries { gridPos: { w: 24 } },
          panels.poolConnectionQueueDepthTimeSeries { gridPos: { w: 12 } },
          panels.poolConnectionQueueServicedTimeSeries { gridPos: { w: 12 } },
      ...
      virtualServerOverviewRow:
        ...
        + g.panel.row.withPanels([
          ...
          panels.virtualServerTrafficInboundTimeSeries { gridPos: { w: 6 } },
          panels.virtualServerTrafficOutboundTimeSeries { gridPos: { w: 6 } },
          panels.virtualServerEphemeralTrafficInboundTimeSeries { gridPos: { w: 6 } },
          panels.virtualServerEphemeralTrafficOutboundTimeSeries { gridPos: { w: 6 } },
