  ...
  new(this)::
    {
      ...
      virtualServerOverviewRow:
        ...
        + g.panel.row.withPanels([
          ...
          panels.virtualServerConnectionsTimeSeries { gridPos: { w: 8 } },
          panels.virtualServerEphemeralConnectionsTimeSeries { gridPos: { w: 8 } },
          panels.virtualServerTrafficInboundTimeSeries { gridPos: { w: 8 } },
          ...
          panels.virtualServerEphemeralTrafficOutboundTimeSeries { gridPos: { w: 8 } },
          panels.virtualServerPacketsInboundTimeSeries { gridPos: { w: 8 } },
          panels.virtualServerPacketsOutboundTimeSeries { gridPos: { w: 8 } },
