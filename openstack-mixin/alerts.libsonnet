        ...
        rules: [
          {
            ...
            expr: |||
              100 * openstack_placement_resource_usage{%(filteringSelector)s, resourcetype="MEMORY_MB"} / clamp_min(openstack_placement_resource_total{%(filteringSelector)s, resourcetype="MEMORY_MB"}, 1) > %(alertsWarningPlacementHighMemoryUsage)s
            ||| % this.config,
            'for': '5m',
            labels: {
              severity: 'warning',
          ...
          },
          {
            ...
            expr: |||
              100 * openstack_placement_resource_usage{%(filteringSelector)s, resourcetype="MEMORY_MB"} / clamp_min(openstack_placement_resource_total{%(filteringSelector)s, resourcetype="MEMORY_MB"}, 1) > %(alertsCriticalPlacementHighMemoryUsage)s 
            ||| % this.config,
            'for': '5m',
            labels: {
              severity: 'critical',
          ...
          },
          {
            ...
            expr: |||
              100 * openstack_nova_limits_memory_used{%(filteringSelector)s} / clamp_min(openstack_nova_limits_memory_max{%(filteringSelector)s}, 1) > %(alertsWarningNovaHighVMMemoryUsage)s
            ||| % this.config,
            'for': '5m',
            labels: {
              severity: 'warning',
          ...
          },
          {
            ...
            expr: |||
              100 * openstack_nova_limits_vcpus_used{%(filteringSelector)s} / clamp_min(openstack_nova_limits_vcpus_max{%(filteringSelector)s}, 1) > %(alertsWarningNovaHighVMVCPUUsage)s
            ||| % this.config,
            'for': '5m',
            labels: {
              severity: 'warning',
          ...
          },
          {
            ...
            expr: |||
              100 * openstack_cinder_limits_backup_used_gb{%(filteringSelector)s} / clamp_min(openstack_cinder_limits_backup_max_gb{%(filteringSelector)s}, 1) > %(alertsWarningCinderHighBackupMemoryUsage)s
            ||| % this.config,
            'for': '5m',
            labels: {
              severity: 'warning',
          ...
          },
          {
            ...
            expr: |||
              100 * openstack_cinder_limits_volume_used_gb{%(filteringSelector)s} / clamp_min(openstack_cinder_limits_volume_max_gb{%(filteringSelector)s}, 1) > %(alertsWarningCinderHighVolumeMemoryUsage)s
            ||| % this.config,
            'for': '5m',
            labels: {
              severity: 'warning',
