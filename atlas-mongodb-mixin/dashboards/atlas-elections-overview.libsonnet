...
local stepupElectionsPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_stepUpCmd_called{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - called',
      interval='1m',
    ),
    prometheus.target(
      'increase(mongodb_electionMetrics_stepUpCmd_successful{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
...
local priorityElectionsPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_priorityTakeover_called{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - called',
      interval='1m',
    ),
    prometheus.target(
      'increase(mongodb_electionMetrics_priorityTakeover_successful{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - successful',
      interval='1m',
    ),
...
local takeoverElectionsPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_catchUpTakeover_called{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - called',
      interval='1m',
    ),
    prometheus.target(
      'increase(mongodb_electionMetrics_catchUpTakeover_successful{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - successful',
      interval='1m',
    ),
...
local timeoutElectionsPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_electionTimeout_called{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - called',
      interval='1m',
    ),
    prometheus.target(
      'increase(mongodb_electionMetrics_electionTimeout_successful{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}} - successful',
      interval='1m',
    ),
...
local catchupsPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_numCatchUps{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
...
local catchupsSkippedPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_numCatchUpsSkipped{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}}',
      interval='1m',
    ),
...
local catchupsSucceededPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_numCatchUpsSucceeded{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}}',
      interval='1m',
    ),
...
local catchupsFailedPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_numCatchUpsFailedWithError{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}}',
      interval='1m',
    ),
...
local catchupTimeoutsPanel = {
  ...
  targets: [
    prometheus.target(
      'increase(mongodb_electionMetrics_numCatchUpsTimedOut{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}[$__interval:])',
      datasource=promDatasource,
      legendFormat='{{instance}}',
      interval='1m',
    ),
...
local averageCatchupOperationsPanel = {
  ...
  targets: [
    prometheus.target(
      'mongodb_electionMetrics_averageCatchUpOps{job=~"$job",cl_name=~"$cluster",rs_nm=~"$rs",instance=~"$node"}',
      datasource=promDatasource,
      legendFormat='{{instance}}',
    ),
  ],
