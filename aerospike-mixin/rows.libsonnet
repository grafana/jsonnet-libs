  ...
  new(this):
    {
      ...
      clusterOverview:
        ...
        + g.panel.row.withPanels([
          ...
          panels.topNodesByDiskUsagePanel + g.panel.table.gridPos.withW(12),
      ...
      instanceOverview:
        ...
        + g.panel.row.withPanels([
          ...
          panels.instanceDiskUsagePanel + g.panel.timeSeries.gridPos.withW(18),
      ...
      namespaceOverview:
        ...
        + g.panel.row.withPanels([
          ...
          panels.namespaceDiskUsagePanel + g.panel.timeSeries.gridPos.withW(18),
          panels.namespaceDeadPartitionsPanel + g.panel.stat.gridPos.withW(6),
          panels.namespaceMemoryUsagePanel + g.panel.timeSeries.gridPos.withW(18),
