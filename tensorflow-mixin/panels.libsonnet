  ...
  new(this)::
    {
      ...
      serving_modelRequestRatePanel:
        commonlib.panels.generic.timeSeries.base.new(
          'Model request rate',
          targets=[
            signals.serving.requestCount.asTarget() { interval: '2m' },
          ],
      ...
      serving_modelPredictRequestLatencyPanel:
        commonlib.panels.generic.timeSeries.base.new(
          ...
          targets=[
            signals.serving.requestLatency.asTarget() { interval: '2m' },
          ],
      ...
      serving_modelPredictRuntimeLatencyPanel:
        commonlib.panels.generic.timeSeries.base.new(
          ...
          targets=[
            signals.serving.runtimeLatency.asTarget() { interval: '2m' },
          ],
      ...
      serving_batchQueuingLatencyPanel:
        commonlib.panels.generic.timeSeries.base.new(
          ...
          targets=[
            signals.serving.batchQueuingLatency.asTarget() { interval: '2m' },
          ],
      ...
      serving_batchQueueThroughputPanel:
        commonlib.panels.generic.timeSeries.base.new(
          ...
          targets=[
            signals.serving.batchQueuingRate.asTarget() { interval: '2m' },
          ],
      ...
      core_graphBuildCallsPanel:
        commonlib.panels.generic.timeSeries.base.new(
          'Graph build calls',
          targets=[
            signals.core.graphBuildCalls.asTarget() { interval: '2m' },
          ],
      ...
      core_graphRunsPanel:
        commonlib.panels.generic.timeSeries.base.new(
          'Graph runs',
          targets=[
            signals.core.graphRuns.asTarget() { interval: '2m' },
          ],
      ...
      core_graphBuildTimePanel:
        commonlib.panels.generic.timeSeries.base.new(
          ...
          targets=[
            signals.core.graphBuildTime.asTarget() { interval: '2m' },
          ],
      ...
      core_graphRunTimePanel:
        commonlib.panels.generic.timeSeries.base.new(
          ...
          targets=[
            signals.core.graphRunTime.asTarget() { interval: '2m' },
          ],
