  ...
  local vmSel = s.virtualMachinesQueriesSelector;
  {
    ...
    signals: {
      ...
      vmModifiedMemoryBallooned: {
        ...
        sources: {
          prometheus: {
            // The `!= 0` drops VMs with no ballooning; it is a series filter, not an
            // aggregation, so it belongs on the base expression.
      ...
      vmDiskReadThroughput: {
        ...
        sources: {
          prometheus: {
            expr: 'label_join(vcenter_vm_disk_throughput{direction="read", object!="", ' + s.virtualMachinesNoVAppQueriesSelector + '}, "disk_path", "/", "vcenter_resource_pool_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_throughput{direction="read", object!="", ' + s.virtualMachinesNoRPoolQueriesSelector + '}, "disk_path", "/", "vcenter_virtual_app_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_throughput{direction="read", object!="", ' + s.virtualMachinesNoRPoolOrVAppQueriesSelector + '}, "disk_path", "/", "vcenter_vm_name","object")',
      ...
      vmDiskReadLatency: {
        ...
        sources: {
          prometheus: {
            expr: 'label_join(vcenter_vm_disk_latency_avg_milliseconds{direction="read", object!="", ' + s.virtualMachinesNoVAppQueriesSelector + '}, "disk_path", "/", "vcenter_resource_pool_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_latency_avg_milliseconds{direction="read", object!="", ' + s.virtualMachinesNoRPoolQueriesSelector + '}, "disk_path", "/", "vcenter_virtual_app_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_latency_avg_milliseconds{direction="read", object!="", ' + s.virtualMachinesNoRPoolOrVAppQueriesSelector + '}, "disk_path", "/", "vcenter_vm_name","object")',
            legendCustomTemplate: '',
          },
        },
      },
      ...
      vmDiskWriteThroughput: {
        ...
        sources: {
          prometheus: {
            expr: 'label_join(vcenter_vm_disk_throughput{direction="write", object!="", ' + s.virtualMachinesNoVAppQueriesSelector + '}, "disk_path", "/", "vcenter_resource_pool_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_throughput{direction="write", object!="", ' + s.virtualMachinesNoRPoolQueriesSelector + '}, "disk_path", "/", "vcenter_virtual_app_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_throughput{direction="write", object!="", ' + s.virtualMachinesNoRPoolOrVAppQueriesSelector + '}, "disk_path", "/", "vcenter_vm_name","object")',
            legendCustomTemplate: '',
          },
        },
      },
      ...
      vmDiskWriteLatency: {
        ...
        sources: {
          prometheus: {
            expr: 'label_join(vcenter_vm_disk_latency_avg_milliseconds{direction="write", object!="", ' + s.virtualMachinesNoVAppQueriesSelector + '}, "disk_path", "/", "vcenter_resource_pool_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_latency_avg_milliseconds{direction="write", object!="", ' + s.virtualMachinesNoRPoolQueriesSelector + '}, "disk_path", "/", "vcenter_virtual_app_inventory_path","vcenter_vm_name","object") or '
                  + 'label_join(vcenter_vm_disk_latency_avg_milliseconds{direction="write", object!="", ' + s.virtualMachinesNoRPoolOrVAppQueriesSelector + '}, "disk_path", "/", "vcenter_vm_name","object")',
            legendCustomTemplate: '',
          },
        },
      },
