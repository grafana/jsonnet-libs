function(this)
  {
    ...
    signals: {
      ...
      criticalSectionTime: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_totalCriticalSectionTimeMillis{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            rangeFunction: 'increase',
            legendCustomTemplate: '{{instance}}',
          },
        },
      ...
      catalogCacheRefreshWaitTime: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_catalogCache_totalRefreshWaitTimeMicros{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}}',
          },
        },
      },
      ...
      catalogCacheOpsBlocked: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_catalogCache_operationsBlockedByRefresh_countAllOperations{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}}',
          },
        },
      },
      ...
      targetingFindAllShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_find_allShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
      ...
      targetingInsertAllShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_insert_allShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
      ...
      targetingUpdateAllShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_update_allShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
      ...
      targetingDeleteAllShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_delete_allShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
      ...
      targetingAggregateAllShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_aggregate_allShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
      ...
      targetingFindManyShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_find_manyShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - find',
          },
        },
      },
      ...
      targetingInsertManyShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_insert_manyShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - insert',
          },
        },
      },
      ...
      targetingUpdateManyShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_update_manyShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - update',
          },
        },
      },
      ...
      targetingDeleteManyShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_delete_manyShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - delete',
          },
        },
      },
      ...
      targetingAggregateManyShards: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_aggregate_manyShards{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - aggregate',
          },
        },
      },
      ...
      targetingFindOneShard: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_find_oneShard{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - find',
          },
        },
      },
      ...
      targetingInsertOneShard: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_insert_oneShard{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - insert',
          },
        },
      },
      ...
      targetingUpdateOneShard: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_update_oneShard{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - update',
          },
        },
      },
      ...
      targetingDeleteOneShard: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_delete_oneShard{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - delete',
          },
        },
      },
      ...
      targetingAggregateOneShard: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_aggregate_oneShard{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - aggregate',
          },
        },
      },
      ...
      targetingFindUnsharded: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_find_unsharded{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - find',
          },
        },
      },
      ...
      targetingInsertUnsharded: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_insert_unsharded{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - insert',
          },
        },
      },
      ...
      targetingUpdateUnsharded: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_update_unsharded{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - update',
          },
        },
      },
      ...
      targetingDeleteUnsharded: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_delete_unsharded{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - delete',
          },
        },
      },
      ...
      targetingAggregateUnsharded: {
        ...
        sources: {
          prometheus: {
            expr: 'mongodb_shardingStatistics_numHostsTargeted_aggregate_unsharded{%(queriesSelector)s, rs_nm=~"$rs_nm"}',
            legendCustomTemplate: '{{instance}} - aggregate',
          },
        },
      },
