// Page-timing breakdown for the two drilldown dashboards. `pivot` is the label
// each series is aggregated by: the "by test" dashboard pins one test and breaks
// it down by node_name, the "by node" dashboard does the reverse.
function(this, pivot)
  {
      ...
      documentCompleteTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - completion' % pivot,
          },
        },
      },
      totalTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - load' % pivot,
          },
        },
      },
      dnsTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - DNS' % pivot,
          },
        },
      },
      sslTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - SSL' % pivot,
          },
        },
      },
      connectTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - connect' % pivot,
          },
        },
      },
      contentLoadTime: {
      ...
      renderStartTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - render' % pivot,
          },
        },
      },
      clientTime: {
      ...
      redirectTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - redirect' % pivot,
          },
        },
      },
      waitTime: {
        ...
        sources: {
          prometheus: {
            ...
            aggKeepLabels: [pivot],
            legendCustomTemplate: '{{%s}} - wait' % pivot,
          },
        },
      },
    },
