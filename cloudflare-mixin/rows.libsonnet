    ...
    zoneOverview:
      ...
      + g.panel.row.withPanels(
        [
          ...
          this.grafana.panels.cachedRequestsPanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
          this.grafana.panels.threatsPanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
          this.grafana.panels.bandwidthPanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
          this.grafana.panels.sslBandwidthPanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
          this.grafana.panels.bandwidthContentTypePanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
          this.grafana.panels.browserMapPanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
          this.grafana.panels.uniqueVisitorsPanel + g.panel.timeSeries.gridPos.withW(12) + g.panel.timeSeries.gridPos.withH(8),
