  ...
  new(this): {
    ...
    instanceServiceSummary:
      ...
      + g.panel.row.withPanels([
        ...
        this.grafana.panels.instanceDocumentOps { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceLatencyDetail { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceQueuedOps { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceCursors { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceScannedAndMoved { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceAsserts { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceGetLastErrorWriteOps { gridPos+: { w: 12, h: 8 } },
        this.grafana.panels.instanceQueryEfficiency { gridPos+: { w: 12, h: 8 } },
