...

{
  new(this): {
    ...
    instanceOverview:
      ...
      + g.panel.row.withCollapsed(false)
      + g.panel.row.withPanels([
        this.grafana.panels.instanceOverviewTable { gridPos+: { w: 24, h: 8 } },
      ]),
    ...
    clusterOverview:
      ...
      + g.panel.row.withPanels([
        ...
        this.grafana.panels.clusterBalancerRunning { gridPos+: { w: 3, h: 6 } },
    ...
    clusterConnections:
      ...
      + g.panel.row.withCollapsed(false)
      + g.panel.row.withPanels([
        this.grafana.panels.clusterConnectionsCurrent { gridPos+: { w: 8, h: 10 } },
        this.grafana.panels.clusterConnectionsAvailable { gridPos+: { w: 8, h: 10 } },
        this.grafana.panels.clusterConnectionsPerShard { gridPos+: { w: 8, h: 10 } },
      ]),
    ...
    clusterAdditionalInfo:
      g.panel.row.new('Replication lag and oplog window')
      + g.panel.row.withCollapsed(false)
      + g.panel.row.withPanels([
