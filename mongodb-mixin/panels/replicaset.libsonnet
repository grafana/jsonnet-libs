  ...
  new(signals, config): {
    ...
    replicasetOperations:
      commonlib.panels.generic.timeSeries.base.new(
        'Operations',
        targets=[
          signals.replicaset.replOpCountersRepl.asTarget() + g.query.prometheus.withInterval('2m'),
          signals.replicaset.replOpCountersMongod.asTarget() + g.query.prometheus.withInterval('2m'),
          signals.replicaset.replOpCountersTotal.asTarget() + g.query.prometheus.withInterval('2m'),
        ],
    ...
    replicasetOplogGetmoreTime:
      commonlib.panels.generic.timeSeries.base.new(
        'Oplog getmore time',
        targets=[signals.replicaset.oplogGetmoreTime.asTarget() + g.query.prometheus.withInterval('2m')],
    ...
    replicasetOplogRecoveryWindow:
      commonlib.panels.generic.timeSeries.base.new(
        ...
        description='Time span covered by the oplog, the window available for replication recovery.'
      )
      + g.panel.timeSeries.standardOptions.withUnit('s'),
    ...
    replicasetOplogProcessingTime:
      commonlib.panels.generic.timeSeries.base.new(
        ...
        targets=[
          signals.replicaset.oplogProcessingDocPreload.asTarget() + g.query.prometheus.withInterval('2m'),
          signals.replicaset.oplogProcessingIndexPreload.asTarget() + g.query.prometheus.withInterval('2m'),
          signals.replicaset.oplogProcessingBatchApply.asTarget() + g.query.prometheus.withInterval('2m'),
        ],
    ...
    replicasetOplogOperations:
      commonlib.panels.generic.timeSeries.base.new(
        'Oplog operations',
        targets=[
          signals.replicaset.oplogOpsDocPreload.asTarget() + g.query.prometheus.withInterval('2m'),
          signals.replicaset.oplogOpsIndexPreload.asTarget() + g.query.prometheus.withInterval('2m'),
          signals.replicaset.oplogOpsBatchApply.asTarget() + g.query.prometheus.withInterval('2m'),
        ],
