...

{
  new(signals, config): {
    ...
    overviewTotalOps:
      commonlib.panels.generic.stat.base.new(
        'Total QPS',
        targets=[signals.overview.totalOps.asTarget() + g.query.prometheus.withInterval('2m')],
    ...
    overviewOpsByInstance:
      commonlib.panels.generic.timeSeries.base.new(
        ...
        targets=[signals.overview.opsByInstance.asTarget() + g.query.prometheus.withInterval('2m')],
