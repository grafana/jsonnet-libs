function(this)
  {
    ...
    signals: {
      ...
      lastElection: {
        ...
        sources: {
          percona_mongodb: {
            expr: 'time() - max by (set) (mongodb_mongod_replset_member_election_date{%(queriesSelector)s})',
            legendCustomTemplate: '{{set}}',
          },
        },
      },
      ...
      replOpCountersRepl: {
        ...
        description: 'Replication operations per second. Series that stay at zero over the range are hidden.',
        type: 'raw',
        unit: 'ops',
        sources: {
          percona_mongodb: {
            expr: |||
              avg by (%(agg)s, type) (irate(mongodb_op_counters_repl_total{%(queriesSelector)s}[$__rate_interval]))
              and
              avg by (%(agg)s, type) (increase(mongodb_op_counters_repl_total{%(queriesSelector)s}[$__range])) > 0
            |||,
      ...
      replOpCountersMongod: {
        ...
        description: 'Replication operations per second from mongod counters. Series that stay at zero over the range are hidden.',
        type: 'raw',
        unit: 'ops',
        sources: {
          percona_mongodb: {
            expr: |||
              avg by (%(agg)s, type) (irate(mongodb_mongod_op_counters_repl_total{%(queriesSelector)s}[$__rate_interval]))
              and
              avg by (%(agg)s, type) (increase(mongodb_mongod_op_counters_repl_total{%(queriesSelector)s}[$__range])) > 0
            |||,
            legendCustomTemplate: 'repl - {{type}}',
          },
        },
      ...
      replOpCountersTotal: {
        name: 'Operations',
        description: 'Total operations per second. Series that stay at zero over the range are hidden.',
        type: 'raw',
        unit: 'ops',
        sources: {
          percona_mongodb: {
            expr: |||
              avg by (%(agg)s, type) (irate(mongodb_op_counters_total{%(queriesSelector)s}[$__rate_interval]))
              and
              avg by (%(agg)s, type) (increase(mongodb_op_counters_total{%(queriesSelector)s}[$__range])) > 0
            |||,
      ...
      heartbeatTime: {
        ...
        sources: {
          percona_mongodb: {
            expr: 'time() - max by (%(agg)s, name) (mongodb_mongod_replset_member_last_heartbeat{%(queriesSelector)s} > 0)',
            legendCustomTemplate: '{{name}}',
          },
        },
      },
      ...
      oplogBufferCount: {
        ...
        sources: {
          percona_mongodb: {
            expr: 'mongodb_mongod_metrics_repl_buffer_count{%(queriesSelector)s} or mongodb_ss_metrics_repl_buffer_apply_count{%(queriesSelector)s}',
            legendCustomTemplate: '{{instance}}',
            aggKeepLabels: ['instance'],
          },
        },
      ...
      oplogRecoveryNowToEnd: {
        ...
        sources: {
          percona_mongodb: {
            ...
            legendCustomTemplate: '{{instance}} - Now to end',
            aggKeepLabels: ['instance'],
          },
        },
      },
      oplogRecoveryRange: {
        ...
        sources: {
          percona_mongodb: {
            ...
            legendCustomTemplate: '{{instance}} - Oplog range',
            aggKeepLabels: ['instance'],
          },
        },
      },
      oplogProcessingDocPreload: {
        ...
        sources: {
          percona_mongodb: {
            ...
            legendCustomTemplate: '{{instance}} - Document preload',
            aggKeepLabels: ['instance'],
          },
        },
      },
      oplogProcessingIndexPreload: {
        ...
        sources: {
          percona_mongodb: {
            ...
            legendCustomTemplate: '{{instance}} - Index preload',
            aggKeepLabels: ['instance'],
          },
        },
      },
      oplogProcessingBatchApply: {
        ...
        sources: {
          percona_mongodb: {
            ...
            legendCustomTemplate: '{{instance}} - Batch apply',
            aggKeepLabels: ['instance'],
          },
        },
      },
